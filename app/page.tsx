...
export default function HomePage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-[#0a0e17] to-[#0f172a]">
      <h1 className="text-4xl font-bold text-[#00d4aa] mb-2">Stacks Snake</h1>
      <p className="text-slate-400 mb-8 max-w-md text-center">
        Play Snake on-chain. Connect your Stacks wallet, start a game, and move with arrow keys. Each move is a transaction—avoid the walls and grow your score.
      </p>
